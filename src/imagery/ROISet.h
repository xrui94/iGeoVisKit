...
/* Regions Of Interest ********************************************************/
        ...
        */
        ...
        /**
            ...
            Returns the newly created region.
        */
        ROI* new_region (const std::string&);
        ...
        */
        ROI* set_current(const std::string&);
...
/* Set ************************************************************************/
        ...
        */
        void remove_region (const std::string&);
        
        
        /**
            Returns a vector of all the Regions of Interest.
        */
        std::vector<ROI*> get_regions ();
        ...
        */
        ...
        /**
            ...
            with the given name.
        */
        bool name_exists (const std::string&);
