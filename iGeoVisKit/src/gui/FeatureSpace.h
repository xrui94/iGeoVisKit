...
// class FeatureSpace:public Window, public GLContainerHandler  // 修改继承关系
class FeatureSpace: public QWidget, public GLContainerHandler
{
    Q_OBJECT
    ...
    public:
        ...
        // FeatureSpace(int LOD, bool only_ROIs, int b1, int b2, int b3, QWidget *parent = nullptr);	// create & display new feature space window
        FeatureSpace(int theLOD, int band1, int band2, int band3, bool onlyROIs_arg);	// create & display new feature space window
